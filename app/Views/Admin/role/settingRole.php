		...
		<div class="col-12">
            ...
            <div class="card border-0 mb-3 shadow-sm">
				...
				<p class="px-3 py-2 mt-0 mb-3">
					<a href="<?php echo base_url(route_to('admin_setting_edit_role', $role->_id)) ?>" class="btn btn-outline-warning btn-block" role="button">Editar</a>
				</p>
            </div>
