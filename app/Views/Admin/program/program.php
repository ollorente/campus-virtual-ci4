...
<div class="container-fluid" id="main">
  ...
  <div class="row">
    <div class="col-12 d-flex justify-content-between align-items-center mb-4">
      <h1 class="h3 text-gray-800">Programa<br><b><?php echo $program->programName ?></b></h1>
    ...
    <div class="col-12">
      ...
      <div class="card border-0 mb-3 shadow-sm">
        <p class="px-3 py-2 my-0">
          <b>Nombre:</b>
          <br /><?php echo $program->programName ?>
        </p>
        <p class="px-3 py-2 my-0">
          <b>Link:</b>
          <br /><?php echo $program->programNameUrl ?>
        </p>
        <p class="px-3 py-2 my-0">
        <div class="custom-control custom-switch mx-3">
          <input
            ...
            name="isActive"
            id="isActive"
            <?php if ($program->isProgramActive == 1) { echo 'checked="checked"'; } else { echo ''; } ?>>
          <label class="custom-control-label" for="isActive">Activo</label>
        </div>
        </p>
        <p class="px-3 py-2 mt-0 mb-3">
          <a href="<?php echo base_url(route_to('admin_edit_program', $program->_id)) ?>" class="btn btn-outline-warning btn-block" role="button">Editar</a>
        </p>
      </div>
